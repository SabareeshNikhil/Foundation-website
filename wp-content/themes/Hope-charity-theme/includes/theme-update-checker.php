...
class ThemeUpdateChecker {
	...
	public function requestUpdate($queryArgs = array()){
		...
		//Pass Theme Updates fields for validation
		$queryArgs['customer_email'] = get_option('pm_ln_micro_themes_user_email');	
		$queryArgs['customer_marketplace'] = get_option('pm_ln_theme_marketplace');
		$queryArgs['customer_themeforest_purchase_code'] = get_option('pm_ln_micro_themes_purchase_code_themeforest');
		$queryArgs['customer_mojo_purchase_code'] = get_option('pm_ln_micro_themes_purchase_code_mojo');
		
		$queryArgs['theme_check_update'] = 1; 
